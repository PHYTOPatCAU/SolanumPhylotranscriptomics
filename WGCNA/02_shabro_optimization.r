# Find networksettings for S. habrochaites
...
sizeGrWindow(12,9)
png(file = "WGCNA/documentation/pics/shabro/filtered_wgcna/sampleClustering.png", width = 1200, height = 900);
par(cex = 0.6);
...
png(file = "WGCNA/documentation/pics/shabro/filtered_wgcna/sft_combined.png", width = 1800, height = 900);
...
# png(file = "WGCNA/documentation/pics/shabro/filtered_wgcna/DeepSplit_sft_9.png", width = 10000, height = 8000, 
#     res=600);
...
png(file = "WGCNA/documentation/pics/shabro/filtered_wgcna/MergeCut_sft_9_ds1.png", width = 10000, height = 8000, 
    res=600);
