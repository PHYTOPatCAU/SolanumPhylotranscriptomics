...
sizeGrWindow(12,9)
png(file = "WGCNA/documentation/pics/schil/filtered_wgcna/sampleClustering_filtered.png", width = 1200, height = 900);
par(cex = 0.6);
...
# Plot the results:
png(file = "WGCNA/documentation/pics/schil/filtered_wgcna/sft_combined.png", width = 1800, height = 900);
...
png(file = "WGCNA/documentation/pics/schil/filtered_wgcna/DeepSplit_sft_9.png", width = 10000, height = 8000, 
    res=600);
...
png(file = "WGCNA/documentation/pics/schil/filtered_wgcna/MergeCut_sft_9_ds2.png", width = 10000, height = 8000, 
    res=600);
