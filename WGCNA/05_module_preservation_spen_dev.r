...
modules <- read.table("/gxfs_work/cau/suaph281/RNAseq/RNAseq_work/data/WGCNA/spen/TOM/module_colors_TOM_filtered_genids.txt", 
    sep=" ", row.names=NULL) %>%
...
write.table(zstat, "/gxfs_work/cau/suaph281/RNAseq/RNAseq_work/data/WGCNA/spen/zstat/2025_01_07_zstat.tsv", sep="\t", row.names = FALSE)

png("WGCNA/documentation/pics/spen/2025_presevation_zstats.png", width = 800, height = 400)
...
png("WGCNA/documentation/pics/spen/2025_presevation_median_rank.png", width = 800, height = 400)
