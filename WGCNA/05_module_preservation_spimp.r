...
modules <- read.table("/gxfs_work/cau/suaph281/RNAseq/RNAseq_work/data/WGCNA/spimp/TOM/TOM_sft_6_ds1_cm2_moduleColors_genids.txt", 
    sep=" ", row.names=NULL) %>%
...
write.table(zstat, "/gxfs_work/cau/suaph281/RNAseq/RNAseq_work/data/WGCNA/spimp/zstat/2024_12_01_zstat.tsv", sep="\t", row.names = FALSE)

png("WGCNA/documentation/pics/spimp/presevation_zstats.png", width = 800, height = 400)
...
png("WGCNA/documentation/pics/spimp/presevation_median_rank.png", width = 800, height = 400)
